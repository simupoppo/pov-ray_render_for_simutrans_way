...
import os
import povray_render_for_simutrans_way as prfs
...
def make_window():
    ...
    def app():
        ...
        output_file = filedialog.asksaveasfilename(
            filetype=[("PNG Image Files","*.png")],defaultextension=".png",initialfile=os.path.splitext(os.path.basename(input_file))[0]
        )
        print(output_file)
    ...
    main_win = tk.Tk()
    main_win.title("simutrans way addon maker with pov-ray")
